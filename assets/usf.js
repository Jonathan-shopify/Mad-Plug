/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 3/7/2024 2:36:06 PM*/
/* Begin custom theme code */
// define templates for the Unsen-The4-1.4 theme
var isotopet4s = { "itemSelector": ".t4s-product", "layoutMode": "masonry" };
var _usfImageWidths;
var filterVl = ['35', '35.5','36','36.5','36.6','37','37.3','37.5']; 
var _usfProductSizes = `
...
`<div class="usf-views">
    <div data-items="2.2.3" class="t4s-layout-switch-wrapper t4s-has-list-view">
        <div class="t4s-layout__switch is--mobile t4s-d-md-flex t4s-d-md-none">
            <button data-btn-as-a="" data-breakpoint="mobile" data-col="1" :class="{'is--active': colMobile == 1 && view === 'grid'}" @click.prevent.stop="onMobileGridViewClick(1)"><span class="t4s_icon_view1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.25 34.69"><rect x="12.16" width="10.09" height="10.09"></rect><rect x="12.16" y="12.3" width="10.09" height="10.09"></rect><rect x="12.16" y="24.61" width="10.09" height="10.09"></rect></svg></span></button>
            <button data-btn-as-a="" data-breakpoint="mobile" data-col="2":class="{'is--active': colMobile == 2 && view === 'grid'}" @click.prevent.stop="onMobileGridViewClick(2)"><span class="t4s_icon_view2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.25 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> </svg></span></button>
            <button data-btn-as-a="" data-breakpoint="mobile" data-col="list_t4s" :class="{'is--active': view === 'list'}"  @click.prevent.stop="onNewListViewClick"><span class="t4s_icon_viewlist"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.73 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect><rect y="24.61" width="10.09" height="10.09"></rect><rect x="12.16" y="3.91" width="46.57" height="2.26"></rect><rect x="12.16" y="16.22" width="46.57" height="2.26"></rect><rect x="12.16" y="28.52" width="46.57" height="2.26"></rect></svg></span></button>
        </div>
        <div class="t4s-layout__switch is--tablet t4s-d-none t4s-d-md-flex t4s-d-lg-none">
            <button data-btn-as-a="" data-breakpoint="tablet" data-col="2" :class="{'is--active': colTablet == 2 && view === 'grid'}" @click.prevent.stop="onTabletGridViewClick(2)"><span class="t4s_icon_view2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.25 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> </svg></span></button>
            <button data-btn-as-a="" data-breakpoint="tablet" data-col="3" :class="{'is--active': colTablet == 3 && view === 'grid'}" @click.prevent.stop="onTabletGridViewClick(3)">
                <span class="t4s_icon_view3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.41 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> <rect x="24.32" width="10.09" height="10.09"></rect> <rect x="24.32" y="12.3" width="10.09" height="10.09"></rect> <rect x="24.32" y="24.61" width="10.09" height="10.09"></rect> </svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="tablet" data-col="4" :class="{'is--active': colTablet == 4 && view === 'grid'}" @click.prevent.stop="onTabletGridViewClick(4)">
                <span class="t4s_icon_view4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46.57 34.69"><rect width="10.09" height="10.09"></rect> <rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> <rect x="24.32" width="10.09" height="10.09"></rect> <rect x="24.32" y="12.3" width="10.09" height="10.09"></rect> <rect x="24.32" y="24.61" width="10.09" height="10.09"></rect> <rect x="36.48" width="10.09" height="10.09"></rect> <rect x="36.48" y="12.3" width="10.09" height="10.09"></rect> <rect x="36.48" y="24.61" width="10.09" height="10.09"></rect> </svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="tablet" data-col="list_t4s"  :class="{'is--active': view === 'list'}" @click.prevent.stop="onNewListViewClick">
                <span class="t4s_icon_viewlist">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.73 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect><rect y="24.61" width="10.09" height="10.09"></rect><rect x="12.16" y="3.91" width="46.57" height="2.26"></rect><rect x="12.16" y="16.22" width="46.57" height="2.26"></rect><rect x="12.16" y="28.52" width="46.57" height="2.26"></rect></svg>
                </span>
            </button>
        </div>
        <div class="t4s-layout__switch is--desktop t4s-d-none t4s-d-lg-flex">
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="2" :class="{'is--active': colDesktop == 2 && view === 'grid'}" @click.prevent.stop="onDesktopGridViewClick(2)"><span class="t4s_icon_view2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.25 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> </svg></span></button>
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="3" :class="{'is--active': colDesktop == 3 && view === 'grid'}" @click.prevent.stop="onDesktopGridViewClick(3)">
                <span class="t4s_icon_view3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.41 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> <rect x="24.32" width="10.09" height="10.09"></rect> <rect x="24.32" y="12.3" width="10.09" height="10.09"></rect> <rect x="24.32" y="24.61" width="10.09" height="10.09"></rect> </svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="4" :class="{'is--active': colDesktop == 4 && view === 'grid'}" @click.prevent.stop="onDesktopGridViewClick(4)">
                <span class="t4s_icon_view4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46.57 34.69"><rect width="10.09" height="10.09"></rect> <rect y="12.3" width="10.09" height="10.09"></rect> <rect y="24.61" width="10.09" height="10.09"></rect> <rect x="12.16" width="10.09" height="10.09"></rect> <rect x="12.16" y="12.3" width="10.09" height="10.09"></rect> <rect x="12.16" y="24.61" width="10.09" height="10.09"></rect> <rect x="24.32" width="10.09" height="10.09"></rect> <rect x="24.32" y="12.3" width="10.09" height="10.09"></rect> <rect x="24.32" y="24.61" width="10.09" height="10.09"></rect> <rect x="36.48" width="10.09" height="10.09"></rect> <rect x="36.48" y="12.3" width="10.09" height="10.09"></rect> <rect x="36.48" y="24.61" width="10.09" height="10.09"></rect> </svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="5" :class="{'is--active': colDesktop == 5 && view === 'grid'}" @click.prevent.stop="onDesktopGridViewClick(5)">
                <span class="t4s_icon_view5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.73 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect><rect y="24.61" width="10.09" height="10.09"></rect><rect x="12.16" width="10.09" height="10.09"></rect><rect x="12.16" y="12.3" width="10.09" height="10.09"></rect><rect x="12.16" y="24.61" width="10.09" height="10.09"></rect><rect x="24.32" width="10.09" height="10.09"></rect><rect x="24.32" y="12.3" width="10.09" height="10.09"></rect><rect x="24.32" y="24.61" width="10.09" height="10.09"></rect><rect x="36.48" width="10.09" height="10.09"></rect><rect x="36.48" y="12.3" width="10.09" height="10.09"></rect><rect x="36.48" y="24.61" width="10.09" height="10.09"></rect><rect x="48.64" width="10.09" height="10.09"></rect><rect x="48.64" y="12.3" width="10.09" height="10.09"></rect><rect x="48.64" y="24.61" width="10.09" height="10.09"></rect></svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="6" :class="{'is--active': colDesktop == 6 && view === 'grid'}" @click.prevent.stop="onDesktopGridViewClick(6)">
                <span class="t4s_icon_view6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70.89 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect><rect y="24.61" width="10.09" height="10.09"></rect><rect x="12.16" width="10.09" height="10.09"></rect><rect x="12.16" y="12.3" width="10.09" height="10.09"></rect><rect x="12.16" y="24.61" width="10.09" height="10.09"></rect><rect x="24.32" width="10.09" height="10.09"></rect><rect x="24.32" y="12.3" width="10.09" height="10.09"></rect><rect x="24.32" y="24.61" width="10.09" height="10.09"></rect><rect x="36.48" width="10.09" height="10.09"></rect><rect x="36.48" y="12.3" width="10.09" height="10.09"></rect><rect x="36.48" y="24.61" width="10.09" height="10.09"></rect><rect x="48.64" width="10.09" height="10.09"></rect><rect x="48.64" y="12.3" width="10.09" height="10.09"></rect><rect x="48.64" y="24.61" width="10.09" height="10.09"></rect><rect x="60.8" width="10.09" height="10.09"></rect><rect x="60.8" y="12.3" width="10.09" height="10.09"></rect><rect x="60.8" y="24.61" width="10.09" height="10.09"></rect></svg>
                </span>
            </button>
            <button data-btn-as-a="" data-breakpoint="desktop" data-col="list_t4s"  :class="{'is--active': view === 'list'}" @click.prevent.stop="onNewListViewClick">
                <span class="t4s_icon_viewlist">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.73 34.69"><rect width="10.09" height="10.09"></rect><rect y="12.3" width="10.09" height="10.09"></rect><rect y="24.61" width="10.09" height="10.09"></rect><rect x="12.16" y="3.91" width="46.57" height="2.26"></rect><rect x="12.16" y="16.22" width="46.57" height="2.26"></rect><rect x="12.16" y="28.52" width="46.57" height="2.26"></rect></svg>
                </span>
            </button>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style1 t4s-col-lg- t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper">
      <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
        ...
        <div v-if="colorOnImage || sizeOnImage" class="t4s-pr-group-variable">
            <div v-if="colorOnImage" class="t4s-product-colors" :data-color-options="dataColorOptions">
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
            </div>
            <template v-if="sizeOnImage">
            `+_usfProductSizes+`
            </template>
        </div>
      ...
      <div class="t4s-product-info">
        <div class="t4s-product-info__inner">
           ...
           <div v-html="descriptionExcerpt != '' ? descriptionExcerpt : _usfListDesc(product.description)" class="t4s-rte"></div>
            ...
            <div v-if="colorCount > 0 && _usfSectionSettings.list_color_pos == '2'" class="t4s-product-colors" :data-color-options="dataColorOptions">
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
                <span class="t4s-pr-color__item"><span class="t4s-pr-color__value bg_color_ntloading"></span></span>
            </div>
            <template v-if="sizeCount > 0 && _usfSectionSettings.list_size_pos == '2'">
            `+_usfProductSizes+`
            </template>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style2 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper">
      <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
          `+_usfProductImage+`
        <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge"></div>
      ...
      <div class="t4s-product-info">
        <div class="t4s-product-info__inner">
            ...
            <div class="t4s-pr-top-info t4s-pr">
                <h3 class="t4s-product-title"><a data-pr-href :href="productUrl" v-html="product.title"></a></h3>
                <usf-plugin v-if="usf.plugins.plugins.find(p => p.render_searchResultsProductWishList)" name="searchResultsProductWishList" :data="pluginData"></usf-plugin>
                <div v-else data-replace-wishlist data-tooltip="top left"></div>
            </div>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style3 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper">
        <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
            `+_usfProductImage+`
            <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge"></div>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style4 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper t4s-pr t4s-oh">
        <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
            `+_usfProductImage+`
            <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge"></div>
            <div v-if="colorOnImage || sizeOnImage" class="t4s-pr-group-variable">
...
<div class="t4s-product t4s-pr-grid t4s-pr-style5 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper t4s-pr t4s-oh">
        <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
            `+_usfProductImage+`
            <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge"></div>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style6 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
    <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper t4s-pr t4s-oh">
        <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
            `+_usfProductImage+`
            <div class="t4s-product-badge" style="display: flex;flex-direction: column;">
                <div class="t4s-product-badge" v-if="!isSoldOut" style="position:unset;">
                    <span style="color: #4956ed;padding-left:5px;font-family:Druk Wide Bold;font-size:12px">24-72H</span>
                </div>
                <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge" style="position:unset;"></div>
                <div class="t4s-product-badge" v-if="checkDate(product.date)" style="position:unset;">
                    <span class="t4s-badge-item t4s-badge-new">New In</span>
                </div>
            </div>
...
<div class="t4s-product t4s-pr-grid t4s-pr-style6 t4s-pr-style7 t4s-col-item" :class="['t4s-pr-' + product.id,{'t4s-color-ontop': colorOnImage,'t4s-size-ontop':sizeOnImage}]" :data-product-options="dataProductOptions" :product-selector="product.id" :data-usf-pid="product.id">
  <div @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="t4s-product-wrapper t4s-pr t4s-oh">
    <div data-cacl-slide class="t4s-product-inner t4s-pr t4s-oh">
        `+_usfProductImage+`
      <div data-product-badge data-sort="sale,new,soldout,preOrder,custom" class="t4s-product-badge"></div>
    ...
    <div class="t4s-product-info">
      ...
      <div v-if="!isDefault" class="t4s-product-swatch__info lazyloadt4s" data-qs-inl :data-rendert4s="product.urlName"></div>
    </div>
  </div>
</div>`,
    // Search result pages
        ...
        <template v-for="facetId in facetFilterIds" v-if="(facet = root.facets.find(fc => fc.id === facetId)) && (f = root.facetFilters[facetId])">
            <template v-for="queryValStr in f[1]">
                <div class="usf-refineby__item usf-pointer usf-clear" @click.prevent.stop="root.removeFacetFilter(facetId, queryValStr)">
                    <button class="usf-btn"><span class="usf-filter-label" v-html="facet.title + ': '"></span><b v-html="root.formatBreadcrumbLabel(facet, f[0], _usfGetUpdatedValue(queryValStr,facet))"></b></button><span class="usf-remove"></span>
                </div>
            </template>
        </template>
    </div>
...
/*
function checkDate(vl){
    var inputDate = new Date(vl);
    var currentDate = new Date();
    var targetDate = new Date(currentDate);
    targetDate.setDate(targetDate.getDate());
    var newLabel = inputDate.getTime() <= targetDate.getTime(); 
 
    return newLabel
}*/

var checkDate = function(day) {
...
usf.event.add('sr_dataReceived', function(t, data){
    if(data.facets.find(item => item.facetName === "option:Talla")){
        var toChange=data.facets.find(item => item.facetName === "option:Talla").labels 
        if(toChange){
            toChange.forEach(item => {
                if (filterVl.includes(item.label)) {
                    item.label += "🔌";
                }
            });
        }  
...
function _usfGetUpdatedValue(label,facet) {
    console.log(facet)
    if (filterVl.includes(label) && facet.facetName=='option:Talla'){
        return label+'🔌';
    }
    return label;
}
usf.event.add('init', function () {    
    ...
    var NewSearchResultsGridItem = {
        ...
        data(){
            ...
            var availableSizes = [];
            var availableColors = [];
            var size_on_image = false;
            var color_on_image = false;
                    ...
                    if(_usf_get_color.includes(name) && _usfGlobalSettings.enable_pr_color){
                        for(let j = 0; j < this.product.variants.length; j ++){
                            ...
                            if(v.options[i] != undefined && !usf.utils.isVariantSoldOut(v)){
                                availableColors.push(o.values[v.options[i]]);
                            }
                        }
                        ...
                        for(let j = 0; j < this.product.variants.length; j ++){
                            var v = this.product.variants[j];
                            if(v.options[i] != undefined && !usf.utils.isVariantSoldOut(v)){
                                var size = o.values[v.options[i]];
                                if(_usfGlobalSettings.show_size_type == '1')
                                    availableSizes.push(size);
                                else if(!size_variants.includes(size))
                                    size_variants.push(size);
                            } 
                        }
            ...
            if(size_count > 0 && _usfSectionSettings.list_size_pos == '1'){
                size_on_image = true;
            }
            if(color_count > 0){
                if(_usfSectionSettings.list_color_pos == '1'){
                    color_on_image = true;
                }
                var id_variants = [];
                var img_options = [];
                ...
                dataColorOptions = { 
                    ...
                    color_variants_avai:availableColors, 
            ...
            var cus_qty = usf.utils.getMetafield(this.product,'theme','cus_qty');
            if(cus_qty == ''){
                cus_qty = 1;
            };
            return {
                ...
                sizeOnImage: size_on_image,
                colorOnImage: color_on_image
            }
        },
        ...
        computed:{
            dataProductOptions(){
                ...
                var obj2 = { 
                    ...
                    unQuickShopInline: this.isDefault
                }
                if(this.hoverImage){
                    obj2.image2 = this.hoverImage.url;
                    obj2.alt = this.hoverImage.alt;
                }else{
                    obj2.image2 = false;
                }
    ...
    // Inheritted component for grid view 6
    ...
    // Inheritted component for grid view 7
    var SearchResultsGridItem7 = {
        mixins: [usf.components.NewSearchResultsGridItem],
        template: usf.templates.searchResultsGridViewItem7,
    }
    usf.register(SearchResultsGridItem7, null, "usf-sr-griditem7");
